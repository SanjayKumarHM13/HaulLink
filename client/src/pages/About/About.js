  ...
  return (
    <div className="about">
      <div className="container">
        <h1>About TruckPort</h1>
        <p>TruckPort is a leading trucking and transportation company dedicated to providing efficient and reliable logistics solutions for businesses of all sizes. With our state-of-the-art fleet and experienced team, we ensure that your goods are delivered safely and on time.</p>
        <h2>Our Mission</h2>
